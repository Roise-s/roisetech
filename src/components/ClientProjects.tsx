  ...
  <nav className="max-w-6xl mx-auto flex flex-col sm:flex-row gap-y-px sm:gap-y-0 sm:gap-x-4" aria-label="Tabs" role="tablist" aria-orientation="horizontal">
    <button type="button" className="hs-tab-active:bg-gray-100 hs-tab-active:hover:border-transparent w-full flex flex-col text-start focus:outline-hidden p-3 md:p-5 rounded-xl hs-tab-active:bg-neutral-800 hover:bg-neutral-800 focus:bg-neutral-800 active" id="tabs-with-card-item-1" aria-selected="true" data-hs-tab="#tabs-with-card-1" aria-controls="tabs-with-card-1" role="tab">
      ...
      <span className="sm:mt-5">
        <span className="hs-tab-active:text-blue-600 block font-semibold  hs-tab-active:text-blue-500 text-neutral-200">All-in-one workspace</span>
        <span className="hidden lg:block mt-2 text-neutral-200">Create a business, whether you’ve got a fresh idea.</span>
      </span>
    </button>
    ...
    <button type="button" className="hs-tab-active:bg-gray-100 hs-tab-active:hover:border-transparent w-full flex flex-col text-start focus:outline-hidden p-3 md:p-5 rounded-xl hs-tab-active:bg-neutral-800 hover:bg-neutral-800 focus:bg-neutral-800" id="tabs-with-card-item-2" aria-selected="false" data-hs-tab="#tabs-with-card-2" aria-controls="tabs-with-card-2" role="tab">
      ...
      <span className="sm:mt-5">
        <span className="hs-tab-active:text-blue-600 block font-semibold  hs-tab-active:text-blue-500 text-neutral-200">Automation on a whole new level</span>
        <span className="hidden lg:block mt-2 text-neutral-200">Use automation to scale campaigns profitably and save time doing it.</span>
      </span>
    </button>
    ...
    <button type="button" className="hs-tab-active:bg-gray-100 hs-tab-active:hover:border-transparent w-full flex flex-col text-start focus:outline-hidden p-3 md:p-5 rounded-xl hs-tab-active:bg-neutral-800 hover:bg-neutral-800 focus:bg-neutral-800" id="tabs-with-card-item-3" aria-selected="false" data-hs-tab="#tabs-with-card-3" aria-controls="tabs-with-card-3" role="tab">
      ...
      <span className="sm:mt-5">
        <span className="hs-tab-active:text-blue-600 block font-semibold  hs-tab-active:text-blue-500 text-neutral-200">Solving problems for every team</span>
        <span className="hidden lg:block mt-2 text-neutral-200">One tool for your company to share knowledge and ship projects.</span>
      </span>
    </button>
  </nav>
  {/* End Tab Nav */}
