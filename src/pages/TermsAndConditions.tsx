    ...
    <section className="bg-gray-900">
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div className="max-w-screen-md mb-8 lg:mb-16">
                ...
                <p className="sm:text-xl text-gray-400">Welcome to Roise Tech Inc. By working with me or using this website, you agree to the following Terms of Service. Please read them carefully before starting a project.</p>
            </div>
            <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    ...
                    <p className="text-gray-400">I provide freelance web development and related services. Specific details of each project will be agreed upon in writing before work begins. Any additional requests not included in the original agreement may require a new quote or added fees.</p>
                </div>
                <div>
                    <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 bg-primary-900">
                    ...
                    <h3 className="mb-2 text-xl font-bold text-white">Project Timelines & Revisions</h3>
                    <p className="text-gray-400">Estimated timelines will be discussed at the start of each project. Clients are expected to provide content, feedback, and approvals promptly.</p>
                </div>
                <div>
                    <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 bg-primary-900">
                    ...
                    <h3 className="mb-2 text-xl font-bold text-white">Client Responsibilities</h3>
                    <p className="text-gray-400">Clients agree to provide accurate information, materials, and feedback necessary to complete the project. Delays in providing these may extend the delivery timeline.</p>
                </div>
                <div>
                    <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 bg-primary-900">
                    ...
                    <p className="text-gray-400">A 10% deposit is required before work begins. The remaining balance is due upon project completion and before delivery of final files. Late payments may result in project delays or additional fees.</p>
                </div>
                <div>
                    <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 bg-primary-900">
                    ...
                    <h3 className="mb-2 text-xl font-bold text-white">Intellectual Property</h3>
                    <p className="text-gray-400">Ownership of the final deliverables transfers to the client after full payment. I reserve the right to showcase completed work in my portfolio or marketing materials unless the client requests otherwise in writing.</p>
                </div>
                <div>
                    <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 bg-primary-900">
                    ...
                    <h3 className="mb-2 text-xl font-bold text-white">Confidentiality</h3>
                    <p className="text-gray-400">I will not share or disclose any confidential information provided by the client. Similarly, clients agree not to misuse my confidential information.</p>
                </div>
            </div>
        </div>
